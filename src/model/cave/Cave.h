...
namespace cave {
  ...
  class Cave {
    public:
      ...
      /**
       * @brief Initializes the cave with a given size and fills it with random values.
       *
       * @param size The size of the cave (number of rows and columns).
       * @param probability The probability of filling a cell with a live state (0.0 to 1.0).
       */
       ...
       *
       * @param life_lim The threshold for cell survival (1-7), determining whether a cell survives.
       * @param death_lim The threshold for cell death (1-7), determining whether a cell dies.
       */
    ...
    private:
      std::vector<bool> ceils_; /**< An array representing the state of cells in the cave. */
  };
