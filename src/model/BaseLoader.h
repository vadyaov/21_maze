...
class BaseLoader {
  public:
     ...
     *
     * Initializes the input file stream and sets the size of the maze/cave to zero.
     */
     ...
     * It checks if the file was successfully opened and reads the size of the maze/cave.
     * If the file path is incorrect, it throws an `std::invalid_argument` exception.
     * If the size is incorrect (e.g., not a square maze, size greater than 50,
     * or size less than 2), it also throws an exception.
     *
     * @param path The path to the file to be opened.
     * @throw std::invalid_argument If the file path is incorrect or the maze/cave size is invalid.
     */
