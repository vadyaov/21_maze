 ...
 *
 * The `MazeWindow` class represents the main window for displaying and interacting with mazes.
 * It provides functionality for opening, generating, finding paths, and saving mazes.
 */
