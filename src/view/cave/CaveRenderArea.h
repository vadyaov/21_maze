 ...
 *
 * The `CaveRenderArea` class provides a rendering area for displaying and
 * simulating caves. It handles the painting of the cave's cells and implements
 * functionality for opening, generating, and simulating caves. This class is
 * designed for use within the `CaveWindow`.
 */
