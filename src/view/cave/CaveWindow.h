 ...
 *
 * The `CaveWindow` class represents the main window for displaying and
 * simulating caves. It provides functionality for opening, generating,
 * simulating caves, and customizing various parameters such as life and death
 * limits, initial chance, size, and colors.
 */
class CaveWindow : public QWidget {
 ...
 public:
  ...
  /**
   * @brief Gets the selected color for representing life cells in the
   * simulation.
   *
  ...
  /**
   * @brief Gets the selected color for representing death cells in the
   * simulation.
   *
 ...
 private:
  CaveRenderArea
      *render_area_; /**< The rendering area for the cave simulation. */
  ...
  QRadioButton *auto_,
      *manually_; /**< Radio buttons for selecting simulation mode. */

  QSpinBox
      *delta_box; /**< Spin box for selecting the simulation delta value. */
  QSpinBox
      *steps_box; /**< Spin box for selecting the number of simulation steps. */
