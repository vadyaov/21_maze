 ...
 *
 * The `MainWindow` class represents the main application window for the Maze & Cave
 * application. It contains two tabs, one for displaying mazes and another for caves.
 */
